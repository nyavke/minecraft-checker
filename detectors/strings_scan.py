...
STRING_PATTERNS = [
    ...
    # Новые клиенты 2024-2026
    (r'SalHack|net\.salhack|me\.salhack',       'SalHack Client',     'danger'),
    (r'GameSense|com\.gamesense|me\.gamesense', 'GameSense Client',   'danger'),
    (r'LambdaClient|me\.lambda|me\.lambdaclient','Lambda Client',     'danger'),
    (r'KAMIBlue|me\.kami|org\.kamiblue',        'KAMI Blue',          'danger'),
    (r'HydraClient|me\.hydra',                  'Hydra Client',       'danger'),
    (r'FDPClient|com\.fdpclient|net\.fdpclient', 'FDP Client',        'danger'),
    (r'ExhibitionClient|me\.exhibition',         'Exhibition Client', 'danger'),
    (r'KryptonClient|me\.krypton|com\.krypton',  'Krypton Client',   'danger'),
    (r'StarHack|me\.starhack',                   'StarHack',         'danger'),
    (r'SpookySky|fan87\.spookysky',              'SpookySky',        'danger'),
    (r'CollapseLoader|com\.collapseloader',      'CollapseLoader',   'danger'),
    (r'NeverixClient|me\.neverix',               'Neverix Client',   'danger'),
    (r'WolframClient|me\.wolfram|com\.wolfram',  'Wolfram Client',   'danger'),
    (r'ZeusClient|me\.zeus|com\.zeusclient',     'Zeus Client',      'danger'),
    (r'AzuraClient|me\.azura',                   'Azura Client',     'danger'),
    (r'PraxisClient|me\.praxis',                 'Praxis Client',    'danger'),
    (r'SlinkyClient|me\.slinky',                 'Slinky Client',    'danger'),
    (r'PhobosClient|me\.phobos|net\.phobos',     'Phobos Client',    'danger'),
    (r'VenomClient|me\.venom',                   'Venom Client',     'danger'),
    (r'BreachClient|me\.breach',                 'Breach Client',    'danger'),
    (r'TenacityClient|me\.tenacity',             'Tenacity Client',  'danger'),
    (r'RavenClient|me\.raven',                   'Raven Client',     'danger'),
    (r'HyperionClient|me\.hyperion',             'Hyperion Client',  'danger'),
    (r'GorillaClient|me\.gorilla',               'Gorilla Client',   'danger'),
    (r'AbyssClient|me\.abyss',                   'Abyss Client',     'danger'),
    (r'me\.thunderhack|com\.thunderhack',        'ThunderHack',      'danger'),
    (r'me\.inertia|net\.inertia',                'Inertia Client',   'danger'),
    (r'me\.bleachhack|org\.bleachhack',          'BleachHack',       'danger'),
    (r'org\.rusherhack|net\.rusherhack',         'RusherHack',       'danger'),
    (r'com\.fluxclient|me\.flux',                'Flux Client',      'danger'),
    (r'salhack\.me',                             'SalHack URL',      'danger'),
    (r'gamesense\.pub',                          'GameSense URL',    'danger'),
    (r'lambda\.best',                            'Lambda URL',       'danger'),
    (r'kamiblue\.org',                           'KAMI Blue URL',    'danger'),
    (r'rusherhack\.org',                         'RusherHack URL',   'danger'),
    (r'thunderhack\.xyz|thunderhack\.net',       'ThunderHack URL',  'danger'),
    (r'collapseloader\.org',                     'CollapseLoader URL','danger'),
    (r'wolfram\.codes',                          'Wolfram URL',      'danger'),
    (r'inertia\.is',                             'Inertia URL',      'danger'),
    (r'bleachhack\.net',                         'BleachHack URL',   'danger'),
    (r'krypton\.gg',                             'Krypton URL',      'danger'),
    (r'starhack\.xyz',                           'StarHack URL',     'danger'),
    (r'fdpclient\.xyz',                          'FDP Client URL',   'danger'),
    (r'exhibition\.pw',                          'Exhibition URL',   'danger'),
    (r'meteordevelopment',                       'Meteor Client',    'danger'),
    # === From ProstoTrainer CSV — Hitbox / Ghost Client identifiers ===
    (r'me\.rolleron|me/rolleron',                'rolleron GH',                'danger'),
    (r'zrhx\.nekoparts|zrhx/nekoparts',          'NekoClient',                 'danger'),
    (r'ch0ffaindustries',                         'ch0ffa GH',                  'danger'),
    (r'me\.leansani\.phasma|me/leansani',         'Arbuz GH (phasma)',          'danger'),
    (r'ua\.RastyPaster|RastyPaster',              'RastyPaster GH',             'danger'),
    (r'dvd\.explorer\.nocheat',                   'Pseudoautosprint GH',        'danger'),
    (r'com\.misterpemodder\.shulkerboxtooltip\.module\.impl', 'Pseudoshulker HB', 'danger'),
    (r'com\.vydra\.death',                        'Безымянный GH (vydra)',      'danger'),
    (r'cortezz',                                  'Cortezz Client',             'danger'),
    (r'com\.zxc1337\.hitboxes',                   'NN HB (zxc1337)',            'danger'),
    (r'org\.legendary\.tekkira',                  'NN Fabric Hitbox (Tekkira)', 'danger'),
    (r'com\.github\.l3nnartt\.fullbright',        'FullBright HB (l3nnartt)',   'danger'),
    (r'org\.yeat|org/yeat',                       'HB/Bot (yeat)',              'danger'),
    (r'ryo\.qts|ryo/qts',                         'HB (ryo/qts)',               'danger'),
    (r'net\.bing\.autoattackmod',                 'freedtyu Triggerbot',        'danger'),
    (r'com\.thatmg393\.autosystemgc',             'NN Triggerbot',              'danger'),
    (r'de\.raik\.betterperspective',              'Better Perspective Triggerbot', 'danger'),
    (r'cum\.example11',                           'Example Addon Triggerbot',   'danger'),
    (r'dev\.addon\.ghost',                        'CapeParticles GH',           'danger'),
    (r'sacura\.sacura|sacura/sacura',             'HB (sacura autosprint)',      'danger'),
    (r'ColonialObfuscator|ColonialBuilders',      'Colonial Obfuscator HB',     'suspicious'),
    (r'dev\.minecraftoptimization',               'MinecraftOptimization HB',   'danger'),
    (r'dev\.jnic',                                'HB obfuscated (dev.jnic)',    'danger'),
    (r'com\.wao\b',                               'Waohitboxes',                'danger'),
    (r'com\.cmdcoders\.cheats',                   'Just GH / HB (cmdcoders)',   'danger'),
    (r'@rejavastealbot',                          'Cheat (rejavastealbot)',      'danger'),
    (r'org\.owned\.vmoid',                        'JustMod HB (vmoid)',          'danger'),
    (r'net\.dezc\.nohurtcam',                     'NoHurtCam Triggerbot',       'danger'),
    (r'me\.bushroot',                             'bush1root Client/HB',        'danger'),
    (r'me\.derick1337',                           'HB (Derick1337)',            'danger'),
    (r'zrhx\.nekoparts',                          'NekoClient',                 'danger'),
    (r'me\.leansani',                             'Arbuz GH',                   'danger'),
    (r'client\.cortezz',                          'Cortezz Client',             'danger'),
    (r'com\.cmdcoders',                           'cmdcoders cheat',            'danger'),
    (r'win32-x86-64.*discord-rpc|discord-rpc.*win32-x86-64', 'Britva GH (discord-rpc)', 'suspicious'),
    (r'me/bushroot/hb/Modules|me\.bushroot\.hb',  'bush1root HB module',        'danger'),
]
